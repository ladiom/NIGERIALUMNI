-- Check what emails are stored in the database (FIXED VERSION)
...
-- 4. Check for specific email (ladiomole@hotmail.com) - COUNT ONLY
...
-- 5. Get detailed info for ladiomole@hotmail.com - SEPARATE QUERIES
SELECT 'USERS TABLE for ladiomole@hotmail.com:' as info;
SELECT id, email, alumni_id, created_at FROM users WHERE email = 'ladiomole@hotmail.com';

SELECT 'PENDING_REGISTRATIONS TABLE for ladiomole@hotmail.com:' as info;
SELECT id, email, alumni_id, created_at FROM pending_registrations WHERE email = 'ladiomole@hotmail.com';

SELECT 'ALUMNI TABLE for ladiomole@hotmail.com:' as info;
SELECT id, email, full_name, created_at FROM alumni WHERE email = 'ladiomole@hotmail.com';
